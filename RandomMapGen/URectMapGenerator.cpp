...
{
    std::map< EMapGeneratorData, std::string> printmatch = { {EMapGeneratorData::Ground,"□"},{EMapGeneratorData::Wall, "■"},{EMapGeneratorData::Door,"★"},{EMapGeneratorData::VoidTile," "},{EMapGeneratorData::Passage, "☆"}};
